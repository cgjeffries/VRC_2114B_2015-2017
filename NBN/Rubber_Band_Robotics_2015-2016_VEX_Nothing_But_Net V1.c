...
#pragma config(Motor,  port1,           rightDrive2,   tmotorVex393_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port5,           leftLauncherBottom, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           leftLauncherTop, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           intake2,       tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port8,           intake1,       tmotorVex393TurboSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           rightLauncherBottom, tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port10,          leftDrive2,    tmotorVex393_HBridge, openLoop)
