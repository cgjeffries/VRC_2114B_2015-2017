...
#pragma config(Motor,  port1,           intake2,       tmotorVex393_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port6,           leftLauncherTop, tmotorVex393TurboSpeed_MC29, openLoop, reversed)
